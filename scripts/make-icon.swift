...
for size in [16, 32, 128, 256, 512] {
    for scale in [1, 2] {
        ...
        corners.move(to: NSPoint(x: 284, y: 330))
        corners.line(to: NSPoint(x: 284, y: 712))
        corners.line(to: NSPoint(x: 464, y: 712))
        corners.line(to: NSPoint(x: 516, y: 650))
        corners.line(to: NSPoint(x: 748, y: 650))
        corners.line(to: NSPoint(x: 748, y: 330))
        corners.close()
        corners.stroke()
